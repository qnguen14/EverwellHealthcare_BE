...
namespace Everwell.DAL.Migrations
{
    ...
    [Migration("20250718114256_AddMenstrualCycleNotificationSupport")]
    partial class AddMenstrualCycleNotificationSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Everwell.DAL.Data.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ChatMessages", "EverWellDB_v2.5");
                });
            ...
            modelBuilder.Entity("Everwell.DAL.Data.Entities.Notification", b =>
                {
                    ...
                    b.Property<Guid?>("MenstrualCycleTrackingId")
                        .HasColumnType("uuid")
                        .HasColumnName("menstrual_cycle_tracking_id");
                    ...
                    b.HasIndex("MenstrualCycleTrackingId");
            ...
            modelBuilder.Entity("Everwell.DAL.Data.Entities.ChatMessage", b =>
                {
                    ...
                    b.HasOne("Everwell.DAL.Data.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Everwell.DAL.Data.Entities.Notification", b =>
                {
                    ...
                    b.HasOne("Everwell.DAL.Data.Entities.MenstrualCycleTracking", "MenstrualCycleTracking")
                        .WithMany()
                        .HasForeignKey("MenstrualCycleTrackingId");
                    ...
                    b.Navigation("MenstrualCycleTracking");
